namespace GFLHApp.Models
{
    public class Producers
    {
        ...
        public string? ImagePath { get; set; } // This uses a ? as the image path is not required to be filled in as they may not want to or be able to upload an image of their farm
