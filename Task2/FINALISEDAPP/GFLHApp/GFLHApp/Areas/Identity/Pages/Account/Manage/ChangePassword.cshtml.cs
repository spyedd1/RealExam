...
namespace GFLHApp.Areas.Identity.Pages.Account.Manage // Places this page model in the Identity area namespace.
{
    ...
    public class ChangePasswordModel : PageModel // Defines the Razor Page model class for this page.
    {
        // ----- Injected Services -----
        ...
        private readonly ILogger<ChangePasswordModel> _logger; // Stores an injected service used by the page model.

        public ChangePasswordModel( // Performs this page model step for the current request.
            ...
            ILogger<ChangePasswordModel> logger) // Writes account flow information to the application log.
        {
        ...
        public class InputModel // Defines the Razor Page model class for this page.
        {
            ...
            [Display(Name = "Current password")] // Sets the friendly label shown for this field.
            public string OldPassword { get; set; } // Performs this page model step for the current request.
        ...
        public async Task<IActionResult> OnGetAsync() // Handles GET requests that display this page.
        {
            ...
            if (!hasPassword) // Checks the condition before continuing this page flow.
            {
                ...
                return RedirectToPage("./SetPassword"); // Redirects the browser after completing this step.
            }
        ...
        public async Task<IActionResult> OnPostAsync() // Handles POST requests submitted from this page.
        {
            ...
            var changePasswordResult = await _userManager.ChangePasswordAsync(user, Input.OldPassword, Input.NewPassword); // Reads or writes a submitted form input value.
            if (!changePasswordResult.Succeeded) // Checks the condition before continuing this page flow.
            {
                foreach (var error in changePasswordResult.Errors) // Loops through each item needed by the page flow.
                {
                    // ----- Validation Logic -----
            ...
            _logger.LogInformation("User changed their password successfully."); // Writes account flow information to the application log.
            StatusMessage = "Your password has been changed."; // Stores a status message for the Razor Page to show.
