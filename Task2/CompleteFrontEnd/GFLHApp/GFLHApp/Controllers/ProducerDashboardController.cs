...
namespace GFLHApp.Controllers
{
    ...
    public class ProducerDashboardController : Controller
    {
        ...
        // POST: ProducerDashboard/ToggleAvailability — AJAX toggle for product available flag
        [HttpPost]
        ...
        // POST: ProducerDashboard/CancelProducerOrder/5 — cancel the entire producer slice at once
        [HttpPost]
        [ValidateAntiForgeryToken]
